...
/*
 * attach_page_private()/detach_page_private() are already provided by
 * <linux/pagemap.h> in this tree. The identical copies that lived here caused
 * a "redefinition" build error, so they were removed.
 */
